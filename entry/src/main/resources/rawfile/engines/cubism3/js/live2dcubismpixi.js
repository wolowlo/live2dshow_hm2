        ...
        Model.prototype.update = function (delta) {
            ...
            if (sort) {
                this.children.sort(function (a, b) {
                    ...
                    var renderOrders = _this._coreModel.renderOrders || _this._coreModel.drawables.renderOrders;
                    var aRenderOrder = renderOrders[aIndex];
                    var bRenderOrder = renderOrders[bIndex];
